...
%% single segment variable (convergent)
routing = 2;
tau_max = 8; % Rucker 2011 -> 0 to 4.91 for parallel. no data for convergnt
tau_p = 0:tau_max; % for each tendon, i
tau_s = combvec(tau_p, tau_p)'; % combination of the 2 tendons
