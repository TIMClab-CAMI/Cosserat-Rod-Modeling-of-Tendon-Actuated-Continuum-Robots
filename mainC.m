...
%% single segment variable (helix)
routing = 3;
tau_max = 10; % Rucker 2011 -> 0.98 to 6.87
tau_p = 1:tau_max; % for each tendon, i
tau_s = [tau_p', zeros(length(tau_p), 1); % combination of the 2 tendons
         zeros(length(tau_p), 1), flip(tau_p')];
